...
apt install aptitude tmux git gcc make zsh kodi python3-virtualenv virtualenv vim cec-utils libcec-dev python3-cec scons swig snapclient libttspico-utils sshfs || exit 1
